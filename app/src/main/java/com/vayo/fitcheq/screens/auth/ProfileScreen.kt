...
fun ProfileScreen(navController: NavController, authViewModel: AuthViewModel){
    ...
    Column(
        modifier = Modifier.Companion.fillMaxSize().padding(10.dp)
        ...
        // Gender Selection
        Spacer(modifier = Modifier.Companion.height(20.dp))
        Text("GENDER:", fontSize = 18.sp, fontWeight = FontWeight.Companion.Bold)
        Row {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                ...
                Text(
                    text = "Male",
                    fontSize = 18.sp,
                    modifier = Modifier.Companion.padding(start = 1.dp)
                )
            }
            Spacer(modifier = Modifier.Companion.width(50.dp))
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
        ...
        //Age GROUP SELECTION
        Text("AGE:", fontSize = 18.sp, fontWeight = FontWeight.Companion.Bold)

        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = ageGroup == AgeGroup.BELOW_18,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = ageGroup == AgeGroup.AGE_18_25,
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = ageGroup == AgeGroup.AGE_25_30,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = ageGroup == AgeGroup.AGE_30_PLUS,
        ...
        //Height SELECTION
        Text("HEIGHT", fontSize = 18.sp, fontWeight = FontWeight.Companion.Bold)

        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = height == HeightGroup.short,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = height == HeightGroup.average,
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = height == HeightGroup.tall,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = height == HeightGroup.very_tall,
        ...
        Text("WHAT DO YOU DO?", fontSize = 18.sp, fontWeight = FontWeight.Companion.Bold)
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = occupation == "College Student",
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = occupation == "Working Professional",
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = occupation == "School Student",
...
//BRANDS KON KON SI
        Text(
            "Which brands usually make up your wardrobe?:", fontSize = 16
                .sp, fontWeight = FontWeight.Companion.Bold
        )

        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = preferplatform == PreferPlatform.cheap,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = preferplatform == PreferPlatform.moderate,
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                    RadioButton(
                        selected = preferplatform == PreferPlatform.expensive,
...
//BODY TYPE
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = bodyType == BodyType.athletic,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = bodyType == BodyType.average,
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = bodyType == BodyType.muscular,
            ...
            Row(verticalAlignment = Alignment.Companion.CenterVertically) {
                RadioButton(
                    selected = bodyType == BodyType.plus_size,
